...
enum GroceryStore {
  static let scenes: [RawScene<SimpleStory>] = [
    GroceryStore_Main.raw,
    GroceryStore_LookAround.raw,
    GroceryStore_AskAboutTheTarget.raw,
    GroceryStore_AskAboutTheBeans.raw,
  ]
}

struct GroceryStore_Main: SceneType {
      ...
      if didLookAroundOnce {
        "Look around some more".onSelect {
          .tell {
            ...
            .replaceWith(GroceryStore_LookAround(main: self))
          }
        }
      } else {
      ...
      if !didAskAboutTheTarget {
        "Ask about the target".onSelect {
          .tell {
            ...
            .replaceWith(GroceryStore_AskAboutTheTarget(main: self))
          }
        }
      }
      ...
      if didAskAboutTheTarget, didNoticeMissingBeans {
        "Ask about the beans".onSelect {
          .tell {
            ...
            .replaceWith(GroceryStore_AskAboutTheBeans())
          }
        }
      }
...
struct GroceryStore_LookAround: SceneType {
  var main: GroceryStore_Main
...
struct GroceryStore_AskAboutTheTarget: SceneType {
  var main: GroceryStore_Main
...
struct GroceryStore_AskAboutTheBeans: SceneType {
  var steps: Steps {
