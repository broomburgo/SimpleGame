...
enum Street {
  static let scenes: [RawScene<SimpleStory>] = [
    Street_Main.raw,
    Street_LookingAround.raw,
  ]
}

struct Street_Main: SceneType {
  var steps: Steps {
    ...
    DO.then { .transitionTo(Street_LookingAround()) }
  }
}

struct Street_LookingAround: SceneType {
