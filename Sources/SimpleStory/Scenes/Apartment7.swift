...
enum Apartment7 {
  static let scenes: [RawScene<SimpleStory>] = [
    Apartment7_Main.raw,
    Apartment7_TheApartment.raw,
  ]
}

struct Apartment7_Main: SceneType {
      ...
      if $0.world.wasTheKeyFound {
        "Open the door with the key".onSelect {
          .tell {
            ...
            .transitionTo(Apartment7_TheApartment())
          }
        }
      }
...
struct Apartment7_TheApartment: SceneType {
  var steps: Steps {
